...
class Policy(object):
    def __init__(self, config):
        ...
        self.context = {
            ...
            'history_index': {},
            'history': [],
            'max_history_train_precision_weighted' : float('-inf'),
            'max_history_test_precision_weighted' : float('-inf'),
            'max_history_train_recall_weighted' : float('-inf'),
            'max_history_test_recall_weighted' : float('-inf'),
            'max_history_train_f1_weighted' : float('-inf'),
            'max_history_test_f1_weighted' : float('-inf'),
            'max_history_train_accuracy' : float('-inf'),
            'max_history_test_accuracy' : float('-inf'),
            'max_history_train_adjusted_mutual_info_score' : float('-inf'),
            'max_history_test_adjusted_mutual_info_score' : float('-inf'),
            'max_history_train_balanced_accuracy' : float('-inf'),
