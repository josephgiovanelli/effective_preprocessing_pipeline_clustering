...
RESULT_PATH = "./results/"
RESULT_PATH = create_directory(RESULT_PATH, "split_mode")
if args.mode == "algorithm":
    SCENARIO_PATH = "./scenarios/split_mode/algorithm"
elif args.mode == "preprocessing_algorithm":
    SCENARIO_PATH = "./scenarios/split_mode/preprocessing_algorithm"
else:
    ...
    for info in to_run.values():
        ...
        if args.mode == "preprocessing_algorithm":
            ...
            for i in range(0, len(pipelines)):
                ...
                cmd = 'python ./split_mode_main.py -s {} -c control.seed={} -p {} -r {} -m {} -np {}'.format(
